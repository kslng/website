...
Internally arrays are handled as a struct, this will only be important if you're
building an interface for KSL in another language. You can find the current
definition details in [std/runtime/rc.h](https://github.com/kslng/ksl/blob/main/std/runtime/rc.h).
